...
COPY commands.sh /commands.sh RUN chmod +x /commands.sh

CMD ["/bin/bash", "/commands.sh"]

**Step 2: Created commands.sh Script
#!/bin/bash echo "Current Directory:" pwd
...
git init git add . git commit -m "Initial commit with Dockerfile and commands.sh"

**Step 6: Pushed to GitHub
git remote add origin https://github.com/nidhish35/Devops_Fat_2.git git push -u origin main
